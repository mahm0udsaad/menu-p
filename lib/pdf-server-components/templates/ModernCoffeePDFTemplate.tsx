...
import { useTemplateData } from '@/components/pdf-templates/TemplateDataProvider';
import TemplateBase from '@/components/pdf-templates/TemplateBase';

export default function ModernCoffeePDFTemplate() {
  ...
  return (
    <TemplateBase className="modern-coffee-template">
      <div className="modern-coffee-container">
        {/* Decorative Elements */}
