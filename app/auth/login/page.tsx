  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-red-50 text-gray-900 overflow-hidden" dir="rtl">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-gradient-to-r from-red-200/30 to-rose-200/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-gradient-to-r from-rose-200/20 to-pink-200/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-red-100/20 to-rose-100/20 rounded-full blur-3xl animate-pulse delay-500"></div>
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-gradient-to-br from-red-600 via-rose-600 to-red-700 relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-20 right-16 w-20 h-20 bg-white/10 rounded-2xl shadow-2xl flex items-center justify-center backdrop-blur-xl border border-white/20 animate-bounce delay-800">
              <ChefHat className="h-10 w-10 text-white" />
            </div>
            <div className="absolute top-32 left-16 w-16 h-16 bg-white/10 rounded-xl shadow-2xl flex items-center justify-center backdrop-blur-xl border border-white/20 animate-bounce delay-800">
              <Coffee className="h-8 w-8 text-white" />
            </div>
            <div className="absolute bottom-32 right-16 w-18 h-18 bg-white/10 rounded-xl shadow-2xl flex items-center justify-center backdrop-blur-xl border border-white/20 animate-bounce delay-800">
              <Utensils className="h-9 w-9 text-white" />
            </div>
            <div className="absolute bottom-20 left-12 w-14 h-14 bg-white/10 rounded-xl shadow-2xl flex items-center justify-center backdrop-blur-xl border border-white/20 animate-bounce delay-800">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-2xl">
              <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20">
                ...
                <div className="text-right">
                  <p className="font-bold text-white">أمان مطلق</p>
              ...
              <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20">
                ...
                <div className="text-right">
                  <p className="font-bold text-white">أداء خاطف</p>
                  <p className="text-sm text-red-200">تحميل أقل من ثانية</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20">
                ...
                <div className="text-right">
                  <p className="font-bold text-white">دعم مميز</p>
                  <p className="text-sm text-red-200">استجابة فورية 24/7</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20">
                ...
                <div className="text-right">
                  <p className="font-bold text-white">ضمان 99.9%</p>
                  <p className="text-sm text-red-200">وقت تشغيل مضمون</p>
                </div>
              </div>
            </div>
          </div>
